...
const val API_KEY = "71b0335cf51e46fbaf255720242109"
...
class MainFragment : Fragment() {
    ...
    private fun updateCurrentCard() = with(binding){
        model.liveDataCurrent.observe(viewLifecycleOwner){
            ...
            val charset1 = Charsets.ISO_8859_1
            val charset2 = Charsets.UTF_8
            tvData.text = it.time
            tvCity.text = String(it.city.toByteArray(charset1), charset2)
